...
public class ShinheuhShinsooAttackArmor {

    Regular     enemy;
    Shinheuh    shinheuh;
    int         expectedHpChange;

    public ShinheuhShinsooAttackArmor(Regular enemy, Shinheuh shinheuh, int expectedHpChange) {
        this.enemy = enemy;
    ...
    @Test
    public void shinsooAttackArmor() {
        int     originalEnemyHp;
        int     actualHpChange;
        Armor   armor;
