...
public class ShinheuhPhysicalAttackHelm {

    Regular     enemy;
    Shinheuh    shinheuh;
    int         expectedHpChange;

    public ShinheuhPhysicalAttackHelm(Regular enemy, Shinheuh shinheuh, int expectedHpChange) {
        this.enemy = enemy;
    ...
    @Test
    public void physicalAttackHelm() {
        int             originalEnemyHp;
        int             actualHpChange;
        Helm            helm;
