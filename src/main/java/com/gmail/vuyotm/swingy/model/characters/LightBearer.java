...
public class LightBearer extends Regular {
    ...
    public LightBearer(String name) {
        this(1, 2, 8, 3, 8, 3, 8, 3, 15, name, Regular.LIGHT_BEARER, 0, null, null, null);
    }

    public LightBearer(int level, int physicalAttack, int physicalDefense, int shinsooAttack, int shinsooDefense, int speed, int evasion, int criticalHit, int hitPts, String name, String classType, int experience, Helm helm, Armor armor, Weapon weapon) {
