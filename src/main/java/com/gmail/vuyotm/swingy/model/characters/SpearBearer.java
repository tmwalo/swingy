...
public class SpearBearer extends Regular {
    ...
    public SpearBearer(String name) {
        this(1, 8, 8, 2, 6, 6, 3, 2, 15, name, Regular.SPEAR_BEARER, 0, null, null, null);
    }

    public SpearBearer(int level, int physicalAttack, int physicalDefense, int shinsooAttack, int shinsooDefense, int speed, int evasion, int criticalHit, int hitPts, String name, String classType, int experience, Helm helm, Armor armor, Weapon weapon) {
